...
{
    public class SalesPosLookupsFlows : ISalesPosLookupsFlows
    {
        ISalesPosLookupsTasks SalesPosLookupsTasks;
        public SalesPosLookupsFlows(ISalesPosLookupsTasks spl)
        {
            this.SalesPosLookupsTasks = spl;
        }
        ...
        public SalesPosLookupsModelsPreview GetPosByIp(DBInfoModel dbInfo, string storeid, string ipAddress, int type = 1)
        {
            // get the results
            SalesPosLookupsModelsPreview getposbyip = SalesPosLookupsTasks.GetPosByIp(dbInfo, storeid, ipAddress, type);
