...
namespace Symposium_DTOs.PosModel_Info
{
    ...
    [DisplayName("Delivery_CustomersBillingAddress")]
    public class Delivery_CustomersBillingAddressDTO
    {
        [Column("ID", Order = 1, TypeName = "BIGINT")]
        [Key]
        [Editable(true)]
        [DisplayName("PK_Delivery_CustomersBillingAddress")]
        public long ID { get; set; }

        [Column("CustomerID", Order = 2, TypeName = "BIGINT")]
        [Required]
        [ForeignKey("FK_Delivery_CustomersBillingAddress_Delivery_Customers")]
        ...
        [ForeignKey("FK_Delivery_CustomersBillingAddress_Delivery_AddressTypes")]
