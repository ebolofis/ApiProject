...
{
    [DisplayName("Ver : 2.0.0.23")]
    public class Version_2_0_0_23
    {
        public List<string> Ver_2_0_0_23 { get; }

        public Version_2_0_0_23()
        {
            Ver_2_0_0_23 = new List<string>();
            Ver_2_0_0_23.Add("ALTER PROCEDURE [dbo].[TR_GetAvailableRestaurantsDatesAndTime] @TotProfiles VARCHAR(2000),  @TotRooms VARCHAR(2000), \n"
                           ...
                           + "		INNER JOIN TR_Reservations AS tr ON tr.Id = trc.ReservationId AND ISNULL(tr.[Status],0) <> 0 \n"
                           ...
                           + "		WHERE tr.ReservationDate BETWEEN @stDate AND @stDate + @dur AND ISNULL(tr.[Status],0) <> 0 \n"
                           ...
                           + "					trRes.ReservationDate BETWEEN @stDate AND @stDate + @dur AND ISNULL(trRes.[Status],0) <> 0 \n"
                           + "			) trr \n"
