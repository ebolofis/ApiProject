...
namespace Symposium_DTOs.PosModel_Info
{
    ...
    public class InvoicesDTO : ITables
    {
        [Column("Id", Order = 1, TypeName = "BIGINT")]
        [Key]
        [Editable(true)]
        [DisplayName("PK_Invoices")]
        ...
        [ForeignKey("FK_Invoices_InvoiceTypes")]
        ...
        [ForeignKey("FK_Invoices_PosInfo")]
        ...
        [ForeignKey("FK_Invoices_PdaModule")]
        ...
        [ForeignKey("FK_Invoices_ClientPos")]
        [Association("ClientPos", "ClientPosId", "Id")]/*Foreign Table, Table Field, Foreign Field*/
        public Nullable<long> ClientPosId { get; set; }

        [Column("EndOfDayId", Order = 19, TypeName = "BIGINT")]
        [ForeignKey("FK_Invoices_EndOfDay")]
        ...
        [Required]
        [DisplayFormatAttribute(DataFormatString = "DF_Invoices_IsPaid", NullDisplayText = "0")]//DefaultValue (Name, Value)
        ...
        [Column("OrderNo", Order = 28, TypeName = "NVARCHAR(2000)")]
        public string OrderNo { get; set; }

        [Column("IsInvoiced", Order = 29, TypeName = "BIT")]
        [Required]
        [DisplayFormatAttribute(DataFormatString = "DF_Invoices_IsInvoiced", NullDisplayText = "0")]//DefaultValue (Name, Value)
