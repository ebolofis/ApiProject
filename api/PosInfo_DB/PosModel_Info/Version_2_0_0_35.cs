...
{
    [DisplayName("Ver : 2.0.0.35")]
    public class Version_2_0_0_35
    {
        public List<string> Ver_2_0_0_35 { get; }

        public Version_2_0_0_35()
        {
            Ver_2_0_0_35 = new List<string>();
            Ver_2_0_0_35.Add("ALTER VIEW VIEW_RPT01_InvoiceHeader AS  \n"
                           ...
                           + "		o.DA_IsPaid, o.IsDelay, o.ItemsChanged  \n"
                           + "		FROM (   \n"
                           ...
                           + "					ISNULL(o.IsDelay,0) IsDelay, isnull(o.ItemsChanged,0) ItemsChanged  \n"
                           ...
                           + "			o.CustomerSecretNotes,o.CustomerLastOrderNotes, o.DA_IsPaid, o.IsDelay, o.ItemsChanged   \n"
                           + "	) o  \n"
                           + "	OUTER APPLY (   \n"
            ...
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_ExtId2] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[ExtId2] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Addresses_ExtId2] ON [dbo].[DA_Addresses] \n"
                           + "( \n"
                           + "	[ExtId2] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Addresses_ExtId1] ON [dbo].[DA_Addresses] \n"
                           + "( \n"
                           + "	[ExtId1] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Orders_ExtId2] ON [dbo].[DA_Orders] \n"
                           + "( \n"
                           + "	[ExtId2] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_LastFirstMobile] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[LastName] ASC, \n"
                           + "	[FirstName] ASC, \n"
                           + "	[Mobile] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_LastFirstPhone2] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[LastName] ASC, \n"
                           + "	[FirstName] ASC, \n"
                           + "	[Phone2] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_LastFirstPhone1] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[LastName] ASC, \n"
                           + "	[FirstName] ASC, \n"
                           + "	[Phone1] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_LastFirstName] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[LastName] ASC, \n"
                           + "	[FirstName] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_Phone1MobilePhone2] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[Phone1] ASC, \n"
                           + "	[Mobile] ASC, \n"
                           + "	[Phone2] ASC \n"
                           + ")");
            Ver_2_0_0_35.Add("CREATE NONCLUSTERED INDEX [IX_DA_Customers_Phone1MobilePhone2IsDel] ON [dbo].[DA_Customers] \n"
                           + "( \n"
                           + "	[Phone1] ASC, \n"
                           + "	[Mobile] ASC, \n"
                           + "	[Phone2] ASC, \n"
