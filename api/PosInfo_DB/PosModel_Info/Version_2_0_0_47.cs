...
{
    [DisplayName("Ver : 2.0.0.47")]
    public class Version_2_0_0_47
    {
        public List<string> Ver_2_0_0_47 { get; }

        public Version_2_0_0_47()
        {
            Ver_2_0_0_47 = new List<string>();

            Ver_2_0_0_47.Add("ALTER VIEW [dbo].[VIEW_RPT01_InvoiceHeader] AS   \n"
                           ...
                           + "              , hpo.Payment    \n"
                           + "              , o.ExtType    \n"
                           + "              , CASE WHEN (ISNULL(EstBillingDate.StringValue,'') = '' OR ISDATE(EstBillingDate.StringValue) = 0) THEN  \n"
                           + "                     DATEADD(mi,40,[day]) \n"
                           + "                ELSE CAST(EstBillingDate.StringValue AS DATETIME) END DeliveryTime \n"
