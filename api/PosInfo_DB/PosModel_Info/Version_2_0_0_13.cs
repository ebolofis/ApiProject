...
{
    [DisplayName("Ver : 2.0.0.13")]
    public class Version_2_0_0_13
    {
        public List<string> Ver_2_0_0_13 { get; }

        public Version_2_0_0_13()
        {
            Ver_2_0_0_13 = new List<string>();
            Ver_2_0_0_13.Add("ALTER PROCEDURE [dbo].[EndOfDayByStaff] @posInfo BIGINT AS  \n"
               + "BEGIN   \n"
               ...
               + "	FROM (  \n"
               + "		/*	Accounts Total Data*/  \n"
               + "		SELECT 0 id, a.[Description], COUNT(DISTINCT(i.id)) ReceiptCount, SUM(t.Amount) Amount, a.Id AccountID, a.[Type] AccountType,  \n"
               ...
               + "END");
            Ver_2_0_0_13.Add("ALTER PROCEDURE [dbo].[EndOfDayTotal] @posInfo BIGINT AS   \n"
                + "BEGIN   \n"
