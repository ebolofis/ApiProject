...
{
    [DisplayName("Ver : 2.0.0.55")]
    public class Version_2_0_0_55
    {
        public List<string> Ver_2_0_0_55 { get; }

        public Version_2_0_0_55()
        {
            Ver_2_0_0_55 = new List<string>();

            Ver_2_0_0_55.Add("ALTER TRIGGER dbo.OrderStatusOnKds ON  dbo.OrderStatus AFTER INSERT \n"
                           + "AS  \n"
                           + "BEGIN \n"
                           ...
                           + "			FROM ( \n"
                           + "				SELECT od.OrderId, od.Id OrderDetailId, od.ProductId ,i.Id IngredientsId, i.[Description] IngredientsDescription, (CASE WHEN ISNULL(i.Qty,0) = 0 THEN 1 ELSE i.Qty END * od.Qty) Qty, \n"
                           + "                  od.SalesTypeId, od.KdsId  \n"
