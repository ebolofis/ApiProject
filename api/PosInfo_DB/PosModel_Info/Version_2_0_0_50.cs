...
{
    [DisplayName("Ver : 2.0.0.50")]
    public class Version_2_0_0_50
    {
        public List<string> Ver_2_0_0_50 { get; }
        public Version_2_0_0_50()
        {
            Ver_2_0_0_50 = new List<string>();

            Ver_2_0_0_50.Add("DECLARE @SQL VARCHAR(4000)  \n"
            ...
            Ver_2_0_0_50.Add("DECLARE @SQL VARCHAR(4000)  \n"
                           ...
                           + "EXEC(@SQL)");
            Ver_2_0_0_50.Add("ALTER PROCEDURE [dbo].[CancelReceipt] (@invoiceId BIGINT, @posInfo BIGINT, @staffId BIGINT, @NewInvoiceId BIGINT OUTPUT) AS   \n"
                               + "BEGIN    \n"
                               + "  \n"
