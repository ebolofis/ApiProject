...
{
    [DisplayName("Ver : 2.0.0.32")]
    public class Version_2_0_0_32
    {

        public List<string> Ver_2_0_0_32 { get; }

        public Version_2_0_0_32()
        {
            Ver_2_0_0_32 = new List<string>();
            Ver_2_0_0_32.Add("ALTER VIEW [dbo].[VIEW_RPT01_InvoiceHeader] AS   \n"
