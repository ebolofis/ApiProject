...
{
    [DisplayName("Ver : 2.0.0.19")]
    public class Version_2_0_0_19
    {
        public List<string> Ver_2_0_0_19 { get; }

        public Version_2_0_0_19()
        {
            Ver_2_0_0_19 = new List<string>();
            Ver_2_0_0_19.Add("ALTER PROCEDURE [dbo].[TR_GetAvailableRestaurantsDatesAndTime] @TotProfiles VARCHAR(2000),  @TotRooms VARCHAR(2000), \n"
                           ...
                           + "		GROUP BY tr.RestId, DATEPART(wk, tr.ReservationDate) \n"
                           + "		UNION ALL \n"
                           + "		SELECT 5 RestrictId, COUNT(trc.RoomNum) Occupancy, 0 WeekNo, tr.RestId RestId, tr.ReservationDate ActiveDate, trc.RoomNum, 0 Meal_Type \n"
                           + "		FROM TR_ReservationCustomers AS trc \n"
                           + "		INNER JOIN TR_Reservations AS tr ON tr.Id = trc.ReservationId \n"
                           ...
                           + "	END \n"
                           + "END");
            Ver_2_0_0_19.Add("IF EXISTS (SELECT 1 FROM sys.indexes AS i WHERE i.name = 'PK_TR_OvewrittenCapacities_Unique2' AND OBJECT_NAME(object_id) = 'TR_OvewrittenCapacities') \n"
                            + "	DROP INDEX PK_TR_OvewrittenCapacities_Unique2 ON dbo.TR_OvewrittenCapacities");
            Ver_2_0_0_19.Add("IF EXISTS (SELECT 1 FROM sys.indexes AS i WHERE i.name = 'PK_TR_OvewrittenCapacities_Unique' AND OBJECT_NAME(object_id) = 'TR_OvewrittenCapacities') \n"
                            + "	DROP INDEX PK_TR_OvewrittenCapacities_Unique ON dbo.TR_OvewrittenCapacities");
            Ver_2_0_0_19.Add("CREATE UNIQUE NONCLUSTERED INDEX [PK_TR_OvewrittenCapacities_Unique] ON [dbo].[TR_OvewrittenCapacities] \n"
                           + "( \n"
                           + "    [RestId] ASC, \n"
                           + "    [Date] ASC, \n"
                           + "    [CapacityId] ASC \n"
                           + ") \n"
                           + " ON [PRIMARY]");
            Ver_2_0_0_19.Add("ALTER  VIEW [dbo].[VIEW_RPT02_InvoiceProducts] AS   \n"
                           ...
                           + "      od.Id OrderDetailId, ISNULL(v.Code, 5) ItemVatCode  \n"
                           + "   FROM Invoices i  \n"
                           ...
                           + "   LEFT OUTER JOIN Vat AS v ON v.Id = odi.VatCode \n"
                           + "   WHERE odi.IsExtra = 0");
            Ver_2_0_0_19.Add("ALTER  VIEW [dbo].[VIEW_RPT03_InvoiceExtras] AS      \n"
                           ...
                           + "      odi.OrderDetailId, ISNULL(v.Code, 5) ItemVatCode   \n"
