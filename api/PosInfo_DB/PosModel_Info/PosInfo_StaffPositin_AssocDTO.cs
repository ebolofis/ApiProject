...
namespace Symposium_DTOs.PosModel_Info
{
    ...
    [DisplayName("PosInfo_StaffPositin_Assoc")]
    public class PosInfo_StaffPositin_AssocDTO
    {
        [Column("Id", Order = 1, TypeName = "BIGINT")]
        [Key]
        [Editable(true)]
        [DisplayName("PK_PosInfo_StaffPositin_Assoc")]
        public long Id { get; set; }

        [Column("PosInfoId", Order = 2, TypeName = "BIGINT")]
        [ForeignKey("FK_PosInfo_StaffPositin_Assoc_PosInfo")]
        [Association("PosInfo", "PosInfoId", "Id")]/*Foreign Table, Table Field, Foreign Field*/
        [MaxLength(1)]
        [MinLength(1)]
        public Nullable<long> PosInfoId { get; set; }

        [Column("StaffPositionId", Order = 3, TypeName = "BIGINT")]
        [ForeignKey("FK_PosInfo_StaffPositin_Assoc_StaffPosition")]
