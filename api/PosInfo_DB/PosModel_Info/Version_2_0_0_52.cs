...
{
    [DisplayName("Ver : 2.0.0.52")]
    public class Version_2_0_0_52
    {
        public List<string> Ver_2_0_0_52 { get; }
        public Version_2_0_0_52()
        {
            Ver_2_0_0_52 = new List<string>();

            Ver_2_0_0_52.Add("ALTER PROCEDURE [dbo].[EndOfDayTotal] @posInfo BIGINT, @bySalesType INT AS     \n"
                           + "BEGIN     \n"
                           ...
                           + "			INNER JOIN Invoices AS i ON i.id = t.InvoicesId AND ISNULL(i.IsPrinted,0) = 1 AND ISNULL(i.IsVoided,0) = 0  \n"
                           + "			CROSS APPLY (  \n"
                           + "				SELECT TOP 1 stt.id , stt.[Description]  \n"
