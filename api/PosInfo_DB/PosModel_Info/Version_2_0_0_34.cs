...
{
    [DisplayName("Ver : 2.0.0.34")]
    public class Version_2_0_0_34
    {
        public List<string> Ver_2_0_0_34 { get; }

        public Version_2_0_0_34()
        {
            Ver_2_0_0_34 = new List<string>();
            Ver_2_0_0_34.Add("ALTER PROCEDURE [dbo].[EndOfDayTotal] @posInfo BIGINT, @bySalesType INT AS    \n"
                           + "BEGIN    \n"
