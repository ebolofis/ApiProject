...
namespace Symposium.Models.Models.ExternalDelivery
{
    public class ForkeyServiceModel
    {
        ForkeyConfig config;
        List<ForkeyDeliveryOrder> orders;
    }

    public class ForkeyConfig
    {
    ...
    public class ForkeyLookups
    {
        public List<PosInfoModel> PosInfoList { get; set; }
        public List<PosInfoDetailModel> PosInfoDetailList { get; set; }
        public List<PricelistModel> PricelistList { get; set; }
        public List<SalesTypesModels> SalesTypeList { get; set; }
        public List<AccountModel> AccountList { get; set; }
        public List<StaffModels> StaffList { get; set; }
        public List<InvoiceTypeModel> InvoiceTypeList { get; set; }
        public List<VatModel> VatList { get; set; }

        public DeliveryCustomerLookupModel DeliveryCustomerLookups { get; set; }
    }
    ...
    public class ExtForkeyObj
    {
        ...
        /// <summary>
        /// Literal of payment method of forkeyorder field
        /// </summary>
        public string payment_method { get; set; }

        /// <summary>
        /// if forkey order is with randezvous and not on received time to 
        /// </summary>
        public Nullable<bool> rendezvous { get; set; }
        
        /// <summary>
        /// Time that randezvous starts 
        /// </summary>
        public Nullable<TimeSpan> start_time { get; set; }
        
        /// <summary>
        /// Time that randezvous ends
        /// </summary>
        public Nullable<TimeSpan> end_time { get; set; }

        /// <summary>
        /// is Printed is a var cause forkey order does not print a captains order until button on delivery action
        /// </summary>
        public Nullable<bool> isPrinted { get; set; }

        /// <summary>
        /// boolean comes from json with couvert or not
        /// </summary>
        public Nullable<bool> with_couvert { get; set; }
        /// <summary>
        /// bell from Json
        ...
        public string bell { get; set; }
        /// <summary>
        /// company name form delivery address
        /// </summary>
        public string company_name { get; set; }

        /// <summary>
        /// Delivery Order Estimate Billing Date
        /// </summary>
        public Nullable<DateTime> EstBillingDate { get; set; }

        /// <summary>
        /// Delivery Order Estimate Takeout Date
        /// </summary>
