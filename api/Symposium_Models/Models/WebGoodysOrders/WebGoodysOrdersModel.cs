...
namespace Symposium.Models.Models.WebGoodysOrders
{

    public class WebGoodysOrdersModel
    {
        /// <summary>
        /// orderno
        /// </summary>
        ...
        public List<WebGoodysProductsModel> products { get; set; }

        public WebGoodysCustomerModel customer { get; set; }
    }

    public class WebGoodysProductsModel
    {
        /// <summary>
        /// item_code e.x  "3030"
        /// </summary>
    ...
    public class WebGoodysCustomerModel
    {
        /// <summary>
