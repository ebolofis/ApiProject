...
namespace Symposium.WebApi.DataAccess.Interfaces.DT
{
    public interface IOrderDT
    {
        ...
        /// <returns></returns>
        List<OrderModel> GetOrderListByOrderDetails(DBInfoModel Store, List<long> OrderDetailsIds);
        ...
        /// <param name="OrderDetailsIds"></param>
        /// <returns></returns>
        List<OrderModel> GetOrderListByIds(DBInfoModel Store, List<long> Ids);
