...
{
    public interface IIngredientCategoriesDT
    {
        /// <summary>
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        UpsertListResultModel DeleteRecordsSendedFromDAServer(DBInfoModel Store, List<IngredCategoriesSched_Model> model);
        ...
        /// <param name="Store"></param>
        /// <returns></returns>
        List<IngredientCategoriesModel> GetAllIngredientCategories(DBInfoModel Store);
    }
}
