...
{
    public interface IDA_LoyaltyDT
    {
        ...
        DA_LoyaltyFullConfigModel GetLoyaltyConfig(DBInfoModel Store);
        ...
        /// <returns></returns>
        long SetLoyaltyConfig(DBInfoModel Store, DA_LoyaltyFullConfigModel Model);
        ...
        int GetLoyaltyPoints(DBInfoModel Store, long Id);
        ...
        DA_LoyaltyRedeemOptionsModel GetLoyaltyRedeemOptions(DBInfoModel Store, long Id, decimal Amount);
        ...
        int CalcPointsFromOrder(DBInfoModel Store, DA_OrderModel Model);

        /// <summary>
        /// εισαγωγή Αρχικών πόντων στο table DA_LoyalPoints
        /// </summary>
        /// <returns></returns>
        long InsertInitPoints(DBInfoModel Store, DACustomerModel Model);
        ...
        /// <param name="Model"></param>
        /// <returns></returns>
        void CheckRedeemPoints(DBInfoModel Store, DA_OrderModel Model);
        ...
        /// <param name="Id">Customer Id</param>
        /// <returns></returns>
        long DeleteCustomerGainPoints(DBInfoModel Store, long Id);
        ...
        /// <returns></returns>
        long DeleteGainPoints(DBInfoModel Store, long Id, long StoreId);

        /// <summary>
        /// Διαγραφή πόντων από table DA_LoyalPoints βάση παλαιότητας
        /// </summary>
        /// <returns></returns>
        long DeletePoints(DBInfoModel Store);
        ...
        /// <param name="StoreId">Id Καταστήματος (αν η κίνηση ΔΕΝ συσχετίζεται με παραγγελία που έγινε σε κατάστημα τότε StoreId=0) </param>
        void AddPoints(DBInfoModel Store, long OrderId, long CustomerId, int Points, DateTime Date, int type, long StoreId);
