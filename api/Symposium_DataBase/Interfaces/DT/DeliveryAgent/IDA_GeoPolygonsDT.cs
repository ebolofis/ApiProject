...
{
    public interface IDA_GeoPolygonsDT
    {
        /// <summary>
        ...
        /// <returns>StoreId (Εάν StoreId = 0 Τότε το κατάστημα δεν ανήκει στο πολύγωνο. Αν StoreId είναι μικρότερο του 0 τότε το πολύγωνο είναι ΑΝΕΝΕΡΓΟ.)</returns>
        ...
        /// <param name="StoreId"></param>
        /// </summary>
        long UpdateDaPolygonsNotesActives(DBInfoModel dbInfo, long StoreId);
