...
namespace Pos_WebApi.Controllers
{
    ...
    {
        GenericRepository<Department> svc;
        private PosEntities db = new PosEntities(false);
        ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public DepartmentController()
        {
            svc = new GenericRepository<Department>(db);
        }
        ...
        public PagedResult<Department> GetDepartment(int page, int pageSize)
        {
        ...
        [HttpPut]
        public HttpResponseMessage PutDepartment(IEnumerable<Department> model)
        {
        ...
        // POST api/Department
        public HttpResponseMessage PostDepartment(Department model)
        {
            if (ModelState.IsValid)
            {
                svc.Add(model);
