...
namespace Pos_WebApi.Controllers
{
    ...
    {
        GenericRepository<Accounts> svc;
        private PosEntities db = new PosEntities(false);
        ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public AccountsController()
        {
            svc = new GenericRepository<Accounts>(db);
        ...
        public PagedResult<Accounts> GetAccounts(int page, int pageSize)
        {
        ...
        // PUT api/Accounts/5
        [HttpPut]
        public HttpResponseMessage PutAccounts(IEnumerable<Accounts> model)
        {
        ...
        // POST api/Accounts
        public HttpResponseMessage PostAccounts(Accounts model)
        {
            if (ModelState.IsValid)
            {
                svc.Add(model);
        ...
        public HttpResponseMessage DeleteAccounts(long id)
        {
