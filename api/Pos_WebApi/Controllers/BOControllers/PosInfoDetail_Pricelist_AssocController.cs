...
{
    public class PosInfoDetail_Pricelist_AssocController : ApiController
    {
        GenericRepository<PosInfoDetail_Pricelist_Assoc> svc;
        private PosEntities db = new PosEntities(false);
        ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public PosInfoDetail_Pricelist_AssocController()
        {
            svc = new GenericRepository<PosInfoDetail_Pricelist_Assoc>(db);
        }

        // GET api/AuthorizedGroup
        public IEnumerable<PosInfoDetail_Pricelist_Assoc> GetPosInfoDetail_Pricelist_Assoc()
        {
            return svc.GetAll();
        }

        public PagedResult<PosInfoDetail_Pricelist_Assoc> GetPosInfoDetail_Pricelist_Assoc(int page, int pageSize)
        {
