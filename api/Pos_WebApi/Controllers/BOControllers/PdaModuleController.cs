...
{
    public class PdaModuleController : ApiController
    {
        GenericRepository<PdaModule> svc;
        private PosEntities db = new PosEntities(false);
        ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public PdaModuleController()
        {
            svc = new GenericRepository<PdaModule>(db);
        }

        // GET api/AuthorizedGroup
        public IEnumerable<PdaModule> GetPdaModule()
        {
            return svc.GetAll();
        }

        public PagedResult<PdaModule> GetPdaModule(int page, int pageSize)
        {
            return svc.GetPaged(x => true, s => "Id", page, pageSize);
        }

        // GET api/AuthorizedGroup/5
        public PdaModule GetPdaModule(long id)
        {
        ...
        [HttpPut]
        public HttpResponseMessage PutPdaModule(IEnumerable<PdaModule> model)
        {
        ...
        public HttpResponseMessage PostPdaModule(PdaModule model)
        {
        ...
        public HttpResponseMessage DeletePdaModule(long id)
        {
