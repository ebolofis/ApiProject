...
{
    public class AuthorizedGroupDetailController : ApiController
    {
        GenericRepository<AuthorizedGroupDetail> svc;
        private PosEntities db = new PosEntities(false);
        ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public AuthorizedGroupDetailController()
        {
            svc = new GenericRepository<AuthorizedGroupDetail>(db);
        }

        // GET api/AuthorizedGroup
        public IEnumerable<AuthorizedGroupDetail> GetAuthorizedGroups()
        {
            return svc.GetAll();
        }

        public PagedResult<AuthorizedGroupDetail> GetAuthorizedGroup(int page, int pageSize)
        {
            return svc.GetPaged(x => true, s => "Id", page, pageSize);
        }

        // GET api/AuthorizedGroup/5
        public AuthorizedGroupDetail GetAuthorizedGroup(long id)
        {
        ...
        [HttpPut]
        public HttpResponseMessage PutAuthorizedGroup(IEnumerable<AuthorizedGroupDetail> model)
        {
        ...
        public HttpResponseMessage PostAuthorizedGroup(AuthorizedGroupDetail model)
        {
