...
namespace Pos_WebApi.Controllers
{
    ...
    {
        GenericRepository<Units> svc;
        private PosEntities db = new PosEntities(false);
        ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public UnitsController()
        {
            svc = new GenericRepository<Units>(db);
        }
        ...
        public PagedResult<Units> GetUnits(int page, int pageSize)
        {
            return svc.GetPaged(x => true, s => "Id", page, pageSize);
        }
        // GET api/Units/5
        public Units GetUnits(long id)
        {
        ...
        // PUT api/Units/5
        [HttpPut]
        public HttpResponseMessage PutUnits(IEnumerable<Units> model)
        {
        ...
        // POST api/Units
        public HttpResponseMessage PostUnits(Units model)
        {
            if (ModelState.IsValid)
            {
                svc.Add(model);
        ...
        // DELETE api/Units/5
        public HttpResponseMessage DeleteUnits(long id)
        {
