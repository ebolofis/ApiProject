...
namespace Pos_WebApi.Controllers
{
    public class KitchenController : ApiController
    {
        ...
        {
            svc = new GenericRepository<Kitchen>(db);
        }
        ...
        public PagedResult<Kitchen> GetKitchen(int page, int pageSize)
        {
        ...
        // PUT api/Kitchen/5
        [HttpPut]
        public HttpResponseMessage PutKitchen(IEnumerable<Kitchen> model)
        {
        ...
        // POST api/Kitchen
        public HttpResponseMessage PostKitchen(Kitchen model)
        {
            if (ModelState.IsValid)
            {
                svc.Add(model);
        ...
        public HttpResponseMessage DeleteKitchen(long id)
        {
